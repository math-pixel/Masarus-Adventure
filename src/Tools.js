...
let arrayObject = {};
function findIndexOfPositionIn2dArray(
  posX,
  posY,
  array,
  sideArrayX,
  ...
  //? start X et Y = xstartWorld et ystartWorld
...
function rectIsInRect(rect1, rect2) {
  if (
    pointIsInRect(
      getTopCornerLeft([rect1[0], rect1[1], rect1[2], rect1[3]]),
      rect2
    )
  ) {
    return true;
  ...
  if (
    pointIsInRect(
      getTopCornerRight([rect1[0], rect1[1], rect1[2], rect1[3]]),
      rect2
    )
  ) {
    return true;
  ...
  if (
    pointIsInRect(
      getBottomCornerLeft([rect1[0], rect1[1], rect1[2], rect1[3]]),
      rect2
    )
  ) {
    return true;
  ...
  if (
    pointIsInRect(
      getBottomCornerRight([rect1[0], rect1[1], rect1[2], rect1[3]]),
      rect2
    )
  ) {
    return true;
